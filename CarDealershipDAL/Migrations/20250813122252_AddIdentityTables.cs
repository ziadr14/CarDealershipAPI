    ...
    public partial class AddIdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Branches__E55E37DEC0AFFC4B", x => x.branch_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Brands__5E5A8E278F70A001", x => x.brand_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Customer__CD65CB8542221935", x => x.customer_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Cars__4C9A0DB33D982CA2", x => x.car_id);
                    table.ForeignKey(
                        name: "FK__Cars__brand_id__4F7CD00D",
                        column: x => x.brand_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Sales__E1EB00B2A34F1E7A", x => x.sale_id);
                    table.ForeignKey(
                        name: "FK__Sales__branch_id__5812160E",
                        column: x => x.branch_id,
                        principalTable: "Branches",
                        principalColumn: "branch_id");
                    table.ForeignKey(
                        name: "FK__Sales__car_id__571DF1D5",
                        column: x => x.car_id,
                        principalTable: "Cars",
                        principalColumn: "car_id");
                    table.ForeignKey(
                        name: "FK__Sales__customer___59063A47",
